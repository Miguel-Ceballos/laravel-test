            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <form class="max-w-sm mx-auto py-10 mb-20" @submit.prevent="storeUser">
                    ...
                    <div class="mb-5">
                        ...
                        <input x-model="formData.email" type="email" id="email" name="email"
                               class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                               placeholder="example@example.com"/>
                    </div>
                    <div class="mb-5">
                        <label for="role" class="block mb-2 text-sm font-medium text-gray-900 ">Role:</label>
                        <select x-model="formData.role" id="role" name="role"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                        >
                                    ...
                                    <template x-for="user in users" :key="user.id">
                                        <tr>
                                            ...
                                            <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                                <div x-text="user.role" class="text-sm text-gray-500"></div>
                                            </td>
                                        </tr>
                                    </template>
                                    </tbody>
